...
CREATE TABLE `empleado` (
    ...
    CONSTRAINT `empleado_ibfk_2` FOREIGN KEY (`CodigoJefe`) REFERENCES `empleado` (`CodigoEmpleado`) ON DELETE SET NULL
);
...
CREATE TABLE `userrols` (
    ...
    CONSTRAINT `userrols_ibfk_1` FOREIGN KEY (`UsuarioId`) REFERENCES `users` (`Id`) ON DELETE CASCADE,
    CONSTRAINT `userrols_ibfk_2` FOREIGN KEY (`RolId`) REFERENCES `rols` (`Id`) ON DELETE CASCADE
);
...
CREATE INDEX `codigo_producto` ON `detalle_pedido` (`codigo_producto`);


CREATE INDEX `empleado_ibfk_2` ON `empleado` (`CodigoJefe`);


CREATE INDEX `codigo_cliente` ON `pedido` (`codigo_cliente`);


CREATE INDEX `gama` ON `producto` (`gama`);
...
CREATE INDEX `RolId` ON `userrols` (`RolId`);
...
INSERT INTO cliente VALUES (11, 'Madrileña de riegos', 'Jose', 'Tacaño', '655983045', '916689215', 'C/Lagañas', 'Fuenlabrada', 'Madrid', 'Madrid', 'Spain', '28943', 20000.00);
INSERT INTO cliente VALUES (12, 'Lasas S.A.', 'Antonio', 'Lasas', '34916540145', '34914851312', 'C/Leganes 15', 'Fuenlabrada', 'Madrid', 'Spain', '28945', 154310.00);
INSERT INTO cliente VALUES (13, 'Camunas Jardines S.L.', 'Pedro', 'Camunas', '34914873241', '34914871541', 'C/Virgenes 45', 'San Lorenzo del Escorial', 'Madrid', 'Spain', '28145', 8, 16481.00);
INSERT INTO cliente VALUES (14, 'Dardena S.A.', 'Juan', 'Rodriguez', '34912453217', '34912484764', 'C/Nueva York 74', 'Madrid', 'Madrid', 'Spain', '28003', 321000.00);
INSERT INTO cliente VALUES (15, 'Jardin de Flores', 'Javier', 'Villar', '654865643', '914538776', 'C/ Oña 34', 'Madrid', 'Madrid', 'Spain', '28950', 40000.00);
INSERT INTO cliente VALUES (16, 'Flores Marivi', 'Maria', 'Rodriguez', '666555444', '912458657', 'C/Leganes24', 'Fuenlabrada', 'Madrid', 'Spain', '28945', 1500.00);
INSERT INTO cliente VALUES (17, 'Flowers, S.A', 'Beatriz', 'Fernandez', '698754159', '978453216', 'C/Luis Salquillo4', 'Montornes del valles', 'Barcelona', 'Spain', '24586', 3500.00);
INSERT INTO cliente VALUES (18, 'Naturajardin', 'Victoria', 'Cruz', '612343529', '916548735', 'Plaza Magallón 15', 'Madrid', 'Madrid', 'Spain', '28011', 5050.00);
INSERT INTO cliente VALUES (19, 'Golf S.A.', 'Luis', 'Martinez', '916458762', '912354475', 'C/Estancado', 'Santa cruz de Tenerife', 'Islas Canarias', 'Spain', '38297', 30000.00);
INSERT INTO cliente VALUES (20, 'Americh Golf Management SL', 'Mario', 'Suarez', '964493072', '964493063', 'C/Letardo', 'Barcelona', 'Cataluña', 'Spain', '12320', 20000.00);
INSERT INTO cliente VALUES (21, 'Aloha', 'Cristian', 'Rodrigez', '916485852', '914489898', 'C/Roman 3', 'Canarias', 'Canarias', 'Spain', '35488', 50000.00);
INSERT INTO cliente VALUES (22, 'El Prat', 'Francisco', 'Camacho', '916882323', '916493211', 'Avenida Tibidabo', 'Barcelona', 'Cataluña', 'Spain', '12320', 30000.00);
INSERT INTO cliente VALUES (23, 'Sotogrande', 'Maria', 'Santillana', '915576622', '914825645', 'C/Paseo del Parque', 'Sotogrande', 'Cadiz', 'Spain', '11310', 60000.00);
INSERT INTO cliente VALUES (24, 'Vivero Humanes', 'Federico', 'Gomez', '654987690', '916040875', 'C/Miguel Echegaray 54', 'Humanes', 'Madrid', 'Spain', '28970', 7430.00);
INSERT INTO cliente VALUES (25, 'Fuenla City', 'Tony', 'Muñoz Mena', '675842139', '915483754', 'C/Callo 52', 'Fuenlabrada', 'Madrid', 'Spain', '28574', 4500.00);
INSERT INTO cliente VALUES (26, 'Jardines y Mansiones Cactus SL', 'Eva María', 'Sánchez', '916877445', '914477777', 'Polígono Industrial Maspalomas, Nº52', 'Móstoles', 'Madrid', 'Madrid', 'Spain', '29874', 76000.00);

INSERT INTO jefe VALUES (1, 'Juan Perez');
INSERT INTO jefe VALUES (2, 'Maria Rodriguez');
INSERT INTO jefe VALUES (3, 'Carlos Lopez');
INSERT INTO jefe VALUES (4, 'Ana Garcia');
INSERT INTO jefe VALUES (5, 'Luis Martinez');
INSERT INTO jefe VALUES (6, 'Laura Fernandez');
INSERT INTO jefe VALUES (7, 'Javier Sanchez');
INSERT INTO jefe VALUES (8, 'Carmen Torres');
INSERT INTO jefe VALUES (9, 'Miguel Rodriguez');
INSERT INTO jefe VALUES (10, 'Isabel Gomez');
